...
FakeVimSettings::FakeVimSettings()
{
    ...
    setup(&maxMapDepth,    1000,  "MaxMapDepth",    "mmd", {});
    setup(&maxFuncDepth,   100,   "MaxFuncDepth",   "mfd", {});
    setup(&autoRead,     false,           "AutoRead",      "ar",    {});
    setup(&autoWrite,    false,           "AutoWrite",     "aw",    {});
    setup(&autoWriteAll, false,           "AutoWriteAll",  "awa",   {});
    setup(&hidden,       false,           "Hidden",        "hid",   {});
    setup(&swapFile,     true,            "SwapFile",      "swf",   {});
    setup(&backup,       false,           "Backup",        "bk",    {});
    setup(&writeBackup,  true,            "WriteBackup",   "wb",    {});
    setup(&writeAny,     false,           "WriteAny",      "wa",    {});
    setup(&equalAlways,  true,            "EqualAlways",   "ea",    {});
    setup(&splitBelow,   false,           "SplitBelow",    "sb",    {});
    setup(&splitRight,   false,           "SplitRight",    "spr",   {});
    setup(&showTitle,    false,           "Title",         "title", {});
    setup(&inferCase,    false,           "InferCase",     "inf",   {});
    setup(&binary,       false,           "Binary",        "bin",   {});
    setup(&endOfLine,    true,            "EndOfLine",     "eol",   {});
    setup(&undoLevels,   1000,            "UndoLevels",    "ul",    {});
    ...
    setup(&dictionary,   "",              "Dictionary",    "dict",  {});
    setup(&thesaurus,    "",              "Thesaurus",     "tsr",   {});
