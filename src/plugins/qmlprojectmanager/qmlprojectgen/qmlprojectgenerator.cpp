...
const DirFilterFlags FILES_ONLY = DirFilterFlag::Files;
const DirFilterFlags DIRS_ONLY = DirFilterFlag::Dirs | DirFilterFlag::Readable | DirFilterFlag::NoDotAndDotDot;
