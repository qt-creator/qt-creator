...
inline constexpr char DEPENDENCIES_DIR[] = "Dependencies";
inline constexpr char COMPONENTS_DIR[] = "Components";
inline constexpr char COMPONENTS_IGNORE_FILE[] = "ignore-in-qds";

inline constexpr char ENV_VARIABLE_CONTROLCONF[] =
    "QT_QUICK_CONTROLS_CONF";

inline constexpr char DO_NOT_EDIT_FILE[] =
    "### This file is automatically generated by Qt Design Studio.\n"
    "### Do not change\n\n";

inline constexpr char TEMPLATE_LINK_LIBRARIES[] =
