...
#include <texteditor/spellcheckmenu.h>
...
void SubmitEditorWidget::editorCustomContextMenuRequested(const QPoint &pos)
{
    ...
    // The highlighter of the description, which is the one that marks its misspellings.
    const auto highlighter = d->description->findChild<TextEditor::SyntaxHighlighter *>(
        {}, Qt::FindDirectChildrenOnly);
    TextEditor::addSpellingActions(menu, highlighter, d->description->cursorForPosition(pos));
    // Extend
