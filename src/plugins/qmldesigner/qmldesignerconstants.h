...
inline constexpr char EVENT_AIASSISTANT[] = "aiAssistant";
inline constexpr char EVENT_ASSETSLIBRARY[] = "assetsLibrary";
inline constexpr char EVENT_CONTENTLIBRARY[] = "contentLibrary";
inline constexpr char EVENT_CONNECTIONEDITOR[] = "connectionEditor";
inline constexpr char EVENT_CURVEEDITOR[] = "curveEditor";
inline constexpr char EVENT_DESIGNSYSTEM[] = "designSystem";
inline constexpr char EVENT_DEVICEMANAGER[] = "deviceManager";
inline constexpr char EVENT_EFFECTCOMPOSER[] = "effectComposer";
inline constexpr char EVENT_EFFECTCOMPOSER_NODE[] = "effectComposerNode";
inline constexpr char EVENT_FORMEDITOR[] = "formEditor";
inline constexpr char EVENT_INSIGHT[] = "insight";
inline constexpr char EVENT_ITEMLIBRARY[] = "itemLibrary";
inline constexpr char EVENT_MATERIALBROWSER[] = "materialBrowser";
inline constexpr char EVENT_MODELEDITOR[] = "modelEditor";
inline constexpr char EVENT_NAVIGATORVIEW[] = "navigatorView";
inline constexpr char EVENT_PROPERTYEDITOR[] = "propertyEditor";
inline constexpr char EVENT_STATESEDITOR[] = "statesEditor";
inline constexpr char EVENT_TEXTEDITOR[] = "textEditor";
inline constexpr char EVENT_TIMELINE[] = "timeline";
inline constexpr char EVENT_TRANSITIONEDITOR[] = "transitionEditor";
inline constexpr char EVENT_TRANSLATIONVIEW[] = "translationView";
inline constexpr char EVENT_3DEDITOR[] = "3DEditor";
