...
public:
    ...
    void operator()(QList<RewriteAction *> &actions, const TextEditor::TabSettingsData &tabSettings) const;
...
private:
    ...
    void compressAddEditActions(QList<RewriteAction *> &actions, const TextEditor::TabSettingsData &tabSettings) const;
