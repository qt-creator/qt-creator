...
inline constexpr char MOVE_TO_PREV_SPLIT[]    = "QtCreator.MoveDocumentToPreviousSplit";
inline constexpr char MOVE_TO_NEXT_SPLIT[]    = "QtCreator.MoveDocumentToNextSplit";
