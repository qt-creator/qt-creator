...
StringListToolAttributeSettingsItem::StringListToolAttributeSettingsItem(StringListToolAttribute *toolAttribute)
...
StringListToolAttributeSettingsItem::~StringListToolAttributeSettingsItem()
{
    m_lineEdit->deleteLater();
}

void StringListToolAttributeSettingsItem::saveData()
{
