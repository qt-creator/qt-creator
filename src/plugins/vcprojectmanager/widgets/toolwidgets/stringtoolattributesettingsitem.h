...
class LineEdit;
class StringToolAttribute;

class StringToolAttributeSettingsItem : public IToolAttributeSettingsWidget
{
public:
    StringToolAttributeSettingsItem(StringToolAttribute *toolAttribute);
...
private:
    LineEdit *m_lineEdit;
    StringToolAttribute *m_toolAttribute;
};
