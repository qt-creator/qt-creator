...
**
****************************************************************************/
#ifndef VCPROJECTMANAGER_INTERNAL_POSTBUILDEVENTTOOL_H
#define VCPROJECTMANAGER_INTERNAL_POSTBUILDEVENTTOOL_H
...
class PostBuildEventTool : public Tool
{
public:
    typedef QSharedPointer<PostBuildEventTool>  Ptr;

    PostBuildEventTool();
    PostBuildEventTool(const PostBuildEventTool &tool);
    ~PostBuildEventTool();
...
#endif // VCPROJECTMANAGER_INTERNAL_POSTBUILDEVENTTOOL_H
