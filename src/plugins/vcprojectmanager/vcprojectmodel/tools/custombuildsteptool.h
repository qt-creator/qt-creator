...
**
****************************************************************************/
#ifndef VCPROJECTMANAGER_INTERNAL_CUSTOMBUILDSTEPTOOL_H
#define VCPROJECTMANAGER_INTERNAL_CUSTOMBUILDSTEPTOOL_H
...
class CustomBuildStepTool : public Tool
{
public:
    typedef QSharedPointer<CustomBuildStepTool> Ptr;

    CustomBuildStepTool();
    CustomBuildStepTool(const CustomBuildStepTool &tool);
    ~CustomBuildStepTool();
    ...
    QStringList outputsDefault() const;
    void setOutputs(const QStringList &outputList);
...
private:
    ...
    LineEdit *m_outputsLineEdit;
    LineEdit *m_additDependLineEdit;
};

} // namespace Internal
} // namespace VcProjectManager

#endif // VCPROJECTMANAGER_INTERNAL_CUSTOMBUILDSTEPTOOL_H
