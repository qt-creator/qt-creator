...
private:
    ...
    Utils::FilePath m_executableFile = Utils::FilePath::fromString("eblink");
    ...
    QString m_deviceScript = "stm32-auto";  // -D <script> ;Select the device script <>.script
...
private:
    ...
    void setInterfaceWidgetType(EBlinkGdbServerProvider::InterfaceType);
