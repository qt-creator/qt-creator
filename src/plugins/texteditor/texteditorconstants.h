...
const char GOTO_FILE_START[]                = "TextEditor.GotoFileStart";
const char GOTO_FILE_END[]                  = "TextEditor.GotoFileEnd";
const char GOTO_FILE_START_WITH_SELECTION[] = "TextEditor.GotoFileStartWithSelection";
const char GOTO_FILE_END_WITH_SELECTION[]   = "TextEditor.GotoFileEndWithSelection";
