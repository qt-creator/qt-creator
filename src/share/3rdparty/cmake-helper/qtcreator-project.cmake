...
# Store the localized prefix that cl.exe prints for every /showIncludes line
if (CMAKE_VERSION GREATER_EQUAL "3.19")
  cmake_language(DEFER CALL set CMAKE_C_CL_SHOWINCLUDES_PREFIX "${CMAKE_C_CL_SHOWINCLUDES_PREFIX}" CACHE STRING "" FORCE)
  cmake_language(DEFER CALL set CMAKE_CXX_CL_SHOWINCLUDES_PREFIX "${CMAKE_CXX_CL_SHOWINCLUDES_PREFIX}" CACHE STRING "" FORCE)
endif()
