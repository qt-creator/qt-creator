...
function(configure_qml_designer Qt6_VERSION)
    ...
    set(PROJECTSTORAGE_QT_MIN_VERSION 6.9.1)
    set(PROJECTSTORAGE_QT_MAX_VERSION 6.10.9)
    ...
    if(Qt6_VERSION VERSION_GREATER_EQUAL ${PROJECTSTORAGE_QT_MIN_VERSION} AND Qt6_VERSION VERSION_LESS ${PROJECTSTORAGE_QT_MAX_VERSION})
       ...
       string(CONCAT QMLDESIGNER_FEATURE_DESC
              "Needs a Qt between ${PROJECTSTORAGE_QT_MIN_VERSION} and ${PROJECTSTORAGE_QT_MAX_VERSION}")
    else()
       set(IS_SUPPORTED_PROJECTSTORAGE_QT OFF)
       string(CONCAT QMLDESIGNER_FEATURE_DESC
              "Requires Qt >= ${QMLDESIGNER_QT6_REQUIRED_VERSION} to build; "
              "fully supported with Qt ${PROJECTSTORAGE_QT_MIN_VERSION}-${PROJECTSTORAGE_QT_MAX_VERSION}")
    endif()
