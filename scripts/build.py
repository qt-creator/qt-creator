...
def build_qtcreator(args, paths):
    ...
    cmake_args = ['cmake',
                  ...
                  '-DBUILD_LIBRARY_SDKTOOLLIB=' + cmake_option(args.with_sdk_tool or common.is_mac_platform()),
                  '-DBUILD_EXECUTABLE_SDKTOOL=' + cmake_option(args.with_sdk_tool or common.is_mac_platform()),
                  '-DQTC_FORCE_XCB=ON',
