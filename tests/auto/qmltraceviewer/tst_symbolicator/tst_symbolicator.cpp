...
int qmltraceviewer_symbolicatorOwnFunction(int seed)
{
...
private slots:
    ...
    void demangleHandlesManglingAndPlainNames()
    {
        ...
        QCOMPARE(demangle("qmltraceviewer_symbolicatorOwnFunction"),
                 QStringLiteral("qmltraceviewer_symbolicatorOwnFunction"));
    ...
    void readsAndAttributesOwnImages()
    {
        ...
        const quint64 addr = addressOf(reinterpret_cast<const void *>(
            &qmltraceviewer_symbolicatorOwnFunction));
    ...
    void liveLabelerSymbolizesDlopenedLibrary()
    {
        ...
        void *fn = dlsym(handle, "qmltraceviewer_symbolicatorFixtureFunction");
        QVERIFY2(fn, dlerror());
        ...
        if (symbolicator.isValid()) {
            QVERIFY2(label.name.contains("qmltraceviewer_symbolicatorFixtureFunction"),
    ...
    void symbolizesOwnTask()
    {
        ...
        QVERIFY2(name.contains("qmltraceviewer_symbolicatorOwnFunction"), qPrintable(name));
    }
};
